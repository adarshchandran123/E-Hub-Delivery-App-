    ...
    const handleSubmit =async (event) => {
      ...
      if(Object.keys(err).length===0){
          ...
          try{
            ...
            axios.post("http://localhost:5000/shop/shopSignup",rest,config).then((response)=>{

              localStorage.setItem('shopDetails',JSON.stringify(rest.email))
                Navigate('/shopEmailVerify')
