    ...
    const handleSubmit =async (event) => {
      ...
      if(Object.keys(err).length===0){
          ...
          try{
            ...
            axios.post("http://localhost:5000/dlvryBoy/dlvryBoySignup",rest,config).then((response)=>{

            localStorage.setItem('dlvryBoyDetails',JSON.stringify(rest.email))
               
            Navigate('/dlvryboyEmailverify')
